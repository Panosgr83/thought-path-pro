...
export function Hero() {
  return (
    <section className="relative isolate w-full overflow-hidden bg-background md:min-h-screen md:bg-ink">
      <div className="relative z-0 w-full overflow-hidden md:absolute md:inset-0 md:h-full">
        <img
          src={heroPortrait}
          alt="Ευδοκία Τίντζη-Σαββιδάκη — Κοινωνική Ψυχολόγος, Παιδοψυχολόγος"
          className="h-auto w-full object-contain md:h-full md:object-cover md:object-[66%_center] lg:object-[60%_center] xl:object-[center_top]"
          loading="eager"
        />
      </div>
      <div
      ...
      <div className="relative z-20 mx-auto flex max-w-7xl items-start px-6 pb-16 pt-8 md:min-h-screen md:items-center md:px-20 md:py-24">
        <div className="fade-up flex max-w-[700px] flex-col text-ink md:text-white">
          ...
          <h1 className="mt-7 font-serif text-[3rem] leading-[1.02] tracking-normal text-ink sm:text-[3.75rem] md:text-[4.5rem] md:text-white">
            Κατανόηση.
            <br />
            Αποδοχή.
            <br />
          ...
          <p className="mt-7 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg md:text-white/85">
